...
app.use(cors({
    origin: function(origin, callback) {
        // Allow requests with no origin (like local file:/// pages, mobile apps, or server-to-server calls)
        ...
        const allowedOrigins = [
            ...
            'https://saxoinvestment.onrender.com',
            'http://localhost:5173',
            'http://localhost:4173',
            'http://127.0.0.1:5173',
            'http://127.0.0.1:4173'
...
app.use('/leaf', express.static(path.join(__dirname, '../leaf/dist')));

// Serve Saxo frontend static files
app.use('/', express.static(path.join(__dirname, '../saxo-source/saxoinvestment-main')));
